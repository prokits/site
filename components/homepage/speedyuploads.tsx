            ...
            <div className="bg-black">
                <div className="container py-24 lg:py-32">
                    ...
                    <div className="mt-5 max-w-2xl text-center mx-auto flex justify-center items-center flex-col">
                        <Image src="/logo/speedyuploads.png" width={300} height={300} alt="SpeedyUploads Logo" className="my-10" />
                        <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">
                            Ultra Fast File Uploads
                        </h1>
                    </div>
                    {/* End Title */}
                    <div className="mt-5 max-w-3xl text-center mx-auto">
                        <p className="text-xl text-muted-foreground">
                            SpeedyUploads uses Azure Blob Storage to provide you with the fastest file uploads possible.
                            No more waiting for your files to upload. Upload your files instantly.
                        </p>
                    </div>
                    {/* Buttons */}
                    ...
                    {/* End Buttons */}
                    <div className="mt-5 md:mt-10 flex justify-center items-center gap-x-1 sm:gap-x-3">
                        <span className="text-sm text-muted-foreground">
                            Pricing:
                        </span>
                        <span className="text-sm font-bold">Free beta for all. </span>
                        <svg
                        ...
                        <Link
                            ...
                            href="https://speedyuploads.instatus.com/"
                            target="_blank"
                        >
                            System Status
